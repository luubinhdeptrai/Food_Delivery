        ...
        if (transparent) {
          ...
          if (isActive) {
            return (
              <TouchableOpacity
                key={tab.id}
                className="flex-col items-center justify-center bg-primary-fixed/30 rounded-2xl px-5 py-2 active:scale-90"
              >
                <Icon size={24} color="#0d631b" />
                <Text className="font-inter text-[11px] font-semibold tracking-wide uppercase text-primary mt-1">
                  {tab.label}
                </Text>
              </TouchableOpacity>
            );
          ...
          return (
            <TouchableOpacity
              key={tab.id}
              className="flex-col items-center justify-center px-5 py-2 active:scale-90 opacity-70"
            >
              <Icon size={24} color="#707a6c" />
              <Text className="font-inter text-[11px] font-semibold tracking-wide uppercase text-outline mt-1">
                {tab.label}
              </Text>
            </TouchableOpacity>
          );
